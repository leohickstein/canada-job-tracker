        ...
        <div className="container mx-auto max-w-6xl space-y-6 py-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
              Stay updated with the latest job opportunities. Configure your
              automated alerts and never miss out on new positions.
            </p>
          </div>
        </div>
      </div>
      ...
      <main className="container mx-auto max-w-4xl px-4 py-8 space-y-6">
          ...
          <div className="relative p-8">
            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Your GitHub Action is already configured to send you daily
                  email updates with new job postings.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-white/30 dark:border-slate-700/50">
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                Include this link in your daily emails to jump straight to new
                job listings:
              </p>
        ...
        <div className="relative overflow-hidden rounded-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-white/20 dark:border-slate-700/30 shadow-lg">
          ...
          <div className="relative p-6">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
              Your automated job alerts are powered by GitHub Actions. The
              system runs daily and sends you personalized job recommendations.
            </p>
